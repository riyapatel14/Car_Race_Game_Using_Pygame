...
# Load the audio file
audio_file = "game.mp3"  # Replace with the path to your audio file
pygame.mixer.music.load(audio_file)
pygame.mixer.music.play()

# To keep the script running long enough to hear the audio
# (since Pygame is non-blocking, the script may end before the audio plays)
